...
![X264_RD](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\X264_RD.PNG)
...
![X264_RD3](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\X264_RD3.PNG)
...
![x2641](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\x2641.PNG)
...
![X2642](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\X2642.PNG)
...
![X2643](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\X2643.PNG)
...
![X2645](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\X2645.PNG)
...
![x2646](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\x2646.PNG)
...
![x2647](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\x2647.PNG)
...
![x2648](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\x2648.PNG)
...
![X2649](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\X2649.PNG)
...
lookahead模块涉及到的代码量偏多，本文做主体的记录。该模块最初的本意应该是根据未来帧的情况确定队列中帧的类型，不仅确定当前帧的类型，还会给未来的帧一个预计的类型，良好的帧结构能够有效的提升编码质量，后续才添加了新的工具例如mbtree和vbv，用于更加精细的调控。由于需要确定帧类型，会进行很多的计算，包括精度较低的的intra、inter cost的计算，mbtree和vbv的计算，这带来了一定的延时，这在RTC场景中不会应用，lookahead应用的场景应该是偏高质量的，可能在一些硬件设备上有所应用。此外，lookahead当中还融入了多线程技术，用于提升计算速度。
...
![x26410](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\x26410.PNG)
...
![x26411](G:\ubuntu_share\av1decoder\av1decoder1\av1decoder\videocodeciamges\x26411.PNG)
